        ...
        <form id={form.id} action={action} onSubmit={form.onSubmit} noValidate>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-red-500 text-xs">{fields.fromName.errors}</p>
                <Input
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <p className="text-red-500 text-xs">{fields.dueDate.errors}</p>
            </div>
          </div>
          ...
          <div>
            ...
            />
            <p className="text-red-500 text-xs">{fields.note.errors}</p>
          </div>
